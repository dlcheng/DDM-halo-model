...
#define pi_smith     (3.14159265358979323846)
...
real Omega_m_hf;		/* matter density parameter */
real Omega_v_hf;		/* cosmogical constant parameter */

real Gamma_hf;		/* shape parameter, see PD2 51 */
real sigma_8_hf;		/* power spectrum normalization */

real n_spec_hf;		/* spectral index of initial power spectrum */

real z0_hf;		/* redshift distribution scale */
real beta_p_hf;		/* redshift distribution power index. If beta_b = 0, a distribution
			 * with a single source redshift at z0 is assumed */
real sigma_epsilon_hf;	/* ellipticity dispersion */
int  nonlinear_hf;         /* 0: linear power spectrum                    */
